...
angular.module('sbAdminApp')
    ...
    //    $state.go('crm.orderList', {start: $filter('date')(today, $scope.dateTimeFormat),
    //                                            end: $filter('date')(tomorrow, $scope.dateTimeFormat)});
    //    };
    //
    //$scope.viewTodayDeliverOrder = function() {
    //        $state.go('crm.orderList', {start: $filter('date')(yesterday, $scope.dateTimeFormat),
    //                                                end: $filter('date')(today, $scope.dateTimeFormat)});
    //    };
    //
    //$scope.viewUncheckedRestaurant = function() {
    //        $state.go('crm.restaurantList', {status: 1});
    //    };
    //
    //$scope.viewUnassignedRestaurant = function() {
    //        $state.go('crm.restaurantList', {adminUserId: 0});
    //    };
