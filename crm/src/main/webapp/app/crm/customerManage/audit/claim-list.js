...
angular.module('sbAdminApp')
    .controller('claimListCtrl', function ($scope, $rootScope, $http, $filter, $stateParams, $location,$window) {


        $scope.reqType=1; //认领审核
        ...
        //
        ////销售类型
        //$http.get($rootScope.rootPath+"/api/customerInfo/customerFollowUpStatus").success(function (data) {
