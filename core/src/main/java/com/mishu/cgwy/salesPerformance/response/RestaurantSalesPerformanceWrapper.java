...
@Data
public class RestaurantSalesPerformanceWrapper {
    ...
    public RestaurantSalesPerformanceWrapper() {
    }

    public RestaurantSalesPerformanceWrapper(String warehouseName, String blockName, Long restaurantId, String restaurantName, String address, String receiver, String sellerName, int currentOrders, int _1Orders, int _2Orders, int _3Orders, BigDecimal currentSalesAmount, BigDecimal _1SalesAmount, BigDecimal _2SalesAmount, BigDecimal _3SalesAmount, BigDecimal currentAvgCostAmount, BigDecimal _1AvgCostAmount, BigDecimal _2AvgCostAmount, BigDecimal _3AvgCostAmount) {
