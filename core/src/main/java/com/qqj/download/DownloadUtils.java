...
public class DownloadUtils {
    public static HttpEntity<byte[]> getHttpEntity() throws Exception {
        byte[] readFileToByteArray = FileUtils.readFileToByteArray(new File("/tmp/com.mirror.cgwy_2.1.3_338.apk"));
